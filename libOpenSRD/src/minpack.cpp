...
//	  Adapted version by Lukas Engelen
//
//  Reference:
//
...
void fdjac1 ( void fcn ( int n, double x[], double f[], int *iflag, double Parameters[] ),
             int n, double x[], double fvec[], double Parameters[], double fjac[], int ldfjac, int *iflag,
...
void fdjac2 ( void fcn ( int m, int n, double x[], double fvec[], int *iflag, double Parameters[] ),
             int m, int n, double x[], double fvec[], double Parameters[], double fjac[], int ldfjac,
...
int hybrd ( void fcn ( int n, double x[], double fvec[], int *iflag, double Parameters[] ),
           int n, double x[],
           double fvec[], double Parameters[], double xtol, int maxfev, int ml, int mu, double epsfcn,
...
//
{
    ...
    for ( ; ; )
    {
        ...
        //
        iflag = 2;
        fdjac1 ( fcn, n, x, fvec, Parameters, fjac, ldfjac, &iflag, ml, mu, epsfcn, wa1, wa2 );
        ...
        for ( ; ; )
        {
            ...
            //
            iflag = 1;
            fcn ( n, wa2, wa4, &iflag, Parameters );
            nfev = nfev + 1;
            if ( iflag < 0 )
            {
                info = iflag;
...
int hybrd1 ( void fcn ( int n, double x[], double fvec[], int *iflag, double Parameters[] ), int n,
            double x[], double fvec[], double Parameters[], double tol, double wa[], int lwa )
...
//
{
    ...
    info = hybrd ( fcn, n, x, fvec, Parameters, xtol, maxfev, ml, mu, epsfcn, wa, mode,
