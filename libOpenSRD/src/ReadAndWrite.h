...
void writeVecToFile(vector<Corner> features, string  file); //write a Float-Vector of corner points to file with path name out
void writePointsToFile(vector<Point3f> features, string  file); //write a Float-Vector of 3D feature points to file with path name out
